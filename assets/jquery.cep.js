...
(function ($) {
  ...
  Cep.prototype = {
    ...
    init: function ($element, options) {
      ...
      this.$window = this.$root.find("#modal-cep-search");
      ...
      this.$element
        .parent()
        .find("span button:first")
        .on("click", function (event) {
          event.preventDefault();
          that.search($(this), true);
        });
      this.$window.find("span button:first").on("click", function () {
    ...
    search: function ($button, cep) {
      ...
      if (cep) {
        if (!val) {
          ...
          // aplica o loading no botão
          $icon = $button.find("i");
          $icon.removeClass("fa-solid fa-magnifying-glass");
      ...
      if (val) {
        ...
        $.get(this.action, params, function (data) {
          ...
          .always(function () {
            ...
            $icon.addClass("fa-solid fa-magnifying-glass");
          });
      }
    },
  };
